...
INCLUDEPATH += $$JASP_REQUIRED_FILES/boost_1_73_0/
...
windows {
  ...
  CONFIG(ReleaseBuild)    { BOOST_POSTFIX = -vc142-mt-$${BOOST_ARCH}-1_73 }
  CONFIG(DebugBuild)      { BOOST_POSTFIX = -vc142-mt-gd-$${BOOST_ARCH}-1_73 }
