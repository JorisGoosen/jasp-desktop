...
{
public:
	OptionComputedColumn(std::string columnName = "", bool computed = true, int columnType = int(columnType::ColumnTypeScale)) : OptionString(columnName), _computed(computed), _columnType(columnType) {}
