...
.contTabBasLogOddsPlotFill <- function(analysisContainer, options, analysisSamples.g,
  ...
  if (options$samplingModel == "hypergeometric")
    ...
    if (is.na(BF10))                stop("The Bayes factor is undefined")
    else if (is.infinite(1 / BF10)) stop("The Bayes factor is too small")
    else if (is.infinite(BF10))     stop("The Bayes factor is infinite")
  }
