...
private:
				...
				bool				convertVecToInt(int colId, const std::vector<std::string> &values, std::vector<int> &intValues, std::set<int> &uniqueValues);
				bool				convertVecToDouble(int colId, const stringvec & values, doublevec & doubleValues);
